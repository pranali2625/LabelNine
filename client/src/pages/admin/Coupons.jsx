...
const emptyCreate = { code: '', discountPercent: 10 }
  ...
  return (
    <div>
      <div className="flex items-center justify-between gap-4 mb-6">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">
            Invite-only codes for selected customers (first order).
          </p>
        </div>
      </div>
      ...
      <form
        ...
        className="bg-white border border-gray-200 p-4 mb-6 flex flex-col sm:flex-row gap-3 sm:items-end"
      >
      ...
      {loading ? (
        ...
        <div className="bg-white border border-gray-200 text-center py-16 text-gray-500 text-sm">
          ...
          No invite coupons yet. Create one above.
        </div>
      ) : (
